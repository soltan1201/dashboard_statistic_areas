...
param = {
    ...
    'anoInicial': 1985,
    'anoFinal':   2024,  # ano final dos pontos de referência disponíveis
...
def change_value_class(feat):
    ...
    dictRemap = {
        ...
        "FLORESTA PLANTADA": 21,       "FLORESTA INUNDÁVEL": 3,
        "CAMPO ALAGADO E ÁREA PANTANOSA": 12,
        "APICUM": 12,                  "FORMAÇÃO CAMPESTRE": 12,
        "AFLORAMENTO ROCHOSO": 22,     "OUTRA FORMAÇÃO NÃO FLORESTAL": 12,
        "PASTAGEM": 21,                "CANA": 21,
        "LAVOURA TEMPORÁRIA": 21,      "LAVOURA PERENE": 21,
        "MINERAÇÃO": 22,               "PRAIA E DUNA": 22,
        "INFRAESTRUTURA URBANA": 22,   "VEGETAÇÃO URBANA": 22,
